...
//   )
// }
// src/components/UpcomingMatches/UpcomingModal.jsx
import React from 'react';
          ...
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <h3 className="text-base font-semibold leading-6 text-gray-900" id="modal-title">Upcoming Matches</h3>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500"> A match Terrace Cup 8 Final is Scheduled . <bold> <Link to={"/upcoming-matches"} style={{
                        textDecoration: 'underline'
                    }}> Click here to See Details</Link></bold>
                     </p>
                  </div>
                </div>
              </div>
